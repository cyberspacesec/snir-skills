...
- `ScreenshotHeaders`, `ScreenshotConsole`, `ScreenshotNetwork`, `ScreenshotWithFormat`, `ScreenshotToPath`, `ScreenshotWithDelay`, `ScreenshotWithTimeout`, and byte-returning variants for focused evidence and output/timing scenarios.
