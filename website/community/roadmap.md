...
<p align="center">🗺️ snir 未来发展方向。</p>
...
timeline
    title snir 演进路线
    section 已完成里程碑
        AI 原生 Skill Bundle 化 : Go SDK + 共享池
        HTTP API : 鉴权 + 并发限流
        CDP Provider 跨进程共享 : 统一 Result + 全量证据
        感知哈希聚类 : 技术栈检测
        富 HTML 报告 : VitePress 文档站 + GitHub Pages
    section 近期
        报告模板增强 : 技术检测指纹库扩充
        设备预设与指纹组合 : 文档持续完善
        evals 覆盖率提升
